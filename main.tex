...
\thesistitle{Learning the Boltzmann Distribution at Different Scales: Adversarial Mapping of Condensed-Phase Molecular Structures } % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Prof. Dr. Kurt \textsc{Kremer}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
