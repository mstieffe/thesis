...
and $p_{AA} (\mathbf{R})$ is the implied equilibrium probability density for a coarse-grained configuration $\mathbf{R}$ by the mapping $\mathbf{M}(\mathbf{r})$ expressed in terms of the fine-grained model
