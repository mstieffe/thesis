...
In its core, coarse-graining consists of two steps: (1) Choose a low-resolution representation of the system and (2) build a CG force field in order to perform a computer simulation of the model. For the latter task, a wide range of different schemes have been developed and two schools of thoughts have been established, referred to as \textit{bottom-up} and \textit{top-down} approaches. 
