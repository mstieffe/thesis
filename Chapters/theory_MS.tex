...
where $r_{ij}$ is the pairwise distance, $q_i$ is the net (partial) charge, and $\epsilon$ and $\sigma$ are the Lennard-Jones parameters, which depend on the particular atom types.  
