...
After the non-bonded pair potentials are obtained, bonded interactions are rescaled until the distributions of the coarse-grained simulation match those of the mapped atomistic simulation. Finally, a $20\,\text{ns}$ production run of the CG simulation is performed. The same simulation parameters are deployed as for the IBI iteration steps.
