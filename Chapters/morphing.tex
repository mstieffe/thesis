...
\caption{Large-scale characteristics of the Fritz model, KG model and morphed structures for both morphing schemes A and B, as well as different morphing scales $s = 2,4,6$. }
...
Comparing the free energy landscapes obtained for the Fritz model in Fig. \ref{} a) an the KG model in Fig. \ref{} b) 
