...
\begin{figure}
  \centering
      \includegraphics[width=0.55\textwidth]{./Figures/adversarial_backmapping/sPS_temp_trans/ps_polymorphs.pdf}
...
Distributions for structural and energetic properties at $453$~K and $313$~K can be found in the middle and right column of Fig.\ref{FIG:sPS_temp_trans_ff_dists}, respectively. The reference system displays a number of significant changes upon cooling: distributions of angles become more compressed, the side peak in the backbone dihedral vanishes, the distributions of Lennard-Jones energies are shifted towards lower energies and the pair correlation function of non-bonded carbon atoms is more peaked. 
