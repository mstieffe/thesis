...
Evaluating large-scale structural features beyond pair-statistics is challenging, since the high dimensionality of the system does not allow to directly visualize the configurational space. However, dimensionality reduction can be used to probe the model's accuracy at higher order. 
