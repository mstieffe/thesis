...
The strong similarity between the concept of latent and coarse-grained variables suggests to apply LVMs to MS modeling. Indead, ML techniques have been applied recently to the coarse-graining of molecular systems.\cite{chakraborty2018encoding, webb2018graph, wang2019coarse} In this thesis, the general approach is to build a LVM for the inverse task, i.e. for the backmapping of molecular structures. In the following, it will be shown that Deep Neural Networks provide an excellent tool learn such complex transformations, as they have the ability to efficiently approximate functions in high dimensions.\cite{hornik1989multilayer, cybenko1992approximation, naitzat2020topology} Moreover, the concept of generative modelling will be introduced providing the techniques to train such models.
