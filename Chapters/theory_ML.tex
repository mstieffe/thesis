...
\subsection{Baysian vs Frequentist}

In the field of statistical inference two different interpretations of probability can be found, known as the bayesian and the frequentist paradigm. In the frequentist view, probabilities are 
...
\subsection{Implicit generative models: The Generative Adversarial Network}
