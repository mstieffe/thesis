...
In the frequentist view, the probability of an event is its relative frequency with which it occurs in many trials. For frequentists, probabilities are only discussed for well defined random-experiments. As the relative frequency of an event can vary for different experiments, probabilities are regarded as the limit for relative frequencies where the change of relative frequencies will diminish,
