...
Note, that Eq. \ref{rnn_unrolled} implies that multiple states of the network have to be stored simultaneously in memory, which possible causes memory issues.
