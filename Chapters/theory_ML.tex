...
Switching between representations of different resolutions is a hallmark of MS modeling. However, such a concept is also well known in the ML community, where lower dimensional representations are described by so called \textit{latent variables}. ML algorithms based on the concept of latent variables are refered to as \textit{latent variable models} (LVM).\cite{van2009dimensionality, ge2018process} 
